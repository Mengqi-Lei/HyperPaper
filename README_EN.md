...
📖 **Detailed Configuration Guide**: See [API_CONFIGURATION_EN.md](API_CONFIGURATION_EN.md)

🚀 **Quick Start**: See [QUICK_START_EN.md](QUICK_START_EN.md)
...
Please see [CONTRIBUTING_EN.md](CONTRIBUTING_EN.md) for detailed contributing guidelines.
